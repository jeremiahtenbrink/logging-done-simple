class Log {
    ...
    private static group: string = 'default';
    ...
    log = ( group: string = "default" ): ILog => {
        ...
        return {
            info: ( message: string, objects: null | {} | {}[] = null,
                    title: string | undefined = undefined, ): void => {
                this.callLogType( message, group, this.info, title, objects,
                    "info" );
                
            },
            
            log: ( message: string, objects: null | {} | {}[] = null,
            ...
            warn: ( message: string, objects: null | {} | {}[] = null,
                    title: string | undefined, ): void => {
